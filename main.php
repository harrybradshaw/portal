...
function FutureBooking(){
    ...
    if ($res) {
        ...
        if ($bookings > 0) {
            ...
            echo '<p> You have no bookings for the next 7 days! </p>';
        }
...
<a href="allequipment.php"> Request Equipment Access</a>
<br>
<!--
<a href="webcal/publicac.php"> View All Sputter Room Bookings</a>
<br>
-->
<a href="viewuserlist.php"> View a User List</a>
<br>
<a href="webcal/login.php?login=rm_-1p015L"> View a Room</a>
<br>
<a href="/../wiki/index.php/Main_Page">DMG Wiki</a>
<header>
